...
var mapArray= [];//initialize array
for (var i = 0 ; i < verMax; i++) {
    mapArray[i] = [];//initialize inner array
    for (var j = 0; j < horMax; j++) {
        mapArray[i][j] = (Math.round(Math.random() * 5));
    }
}
...
canvas.addEventListener('click', function(event) {  //WORKS, retry
